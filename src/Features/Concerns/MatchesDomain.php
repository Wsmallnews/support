 ...
 * 与 isDomainFilterEnabled()（各自的 domain_filter 配置值）。
 *
...
{
    /**
     * 域名过滤开关（默认开启）：关闭时不按域名过滤，模块始终参与输出。
     */
    abstract protected function isDomainFilterEnabled(): bool;
