    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('subject_type')
                ...
                ->formatStateUsing(fn ($state, $record) => FilamentModelHelper::getTypeLabel($record->subject_type)),
            ...
            ExportColumn::make('causer_type')
                ...
                ->formatStateUsing(fn ($state, $record) => FilamentModelHelper::getTypeLabel($record->causer_type)),
