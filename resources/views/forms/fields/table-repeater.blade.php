    ...
    >
        @if (count($containers) || $emptyLabel !== false)
            <div @class([
                ...
                <div >
                    <div @class([
                        'flex justify-end items-center h-12 overflow-hidden',
                        'sr-only' => $hasHiddenHeader,
                        'rounded-t-xl overflow-hidden border-b border-gray-950/5 dark:border-white/20' => ! $hasHiddenHeader,
                    ])>
                        @foreach ($headers as $key => $header)
                            <div
                                @class([
                                    'first:flex-1 px-3 py-2 font-medium bg-gray-100 dark:text-gray-300 dark:bg-gray-900/60',
                        ...
                        @endforeach
                        @if ($hasActions)
                            <div class="w-px ltr:rounded-tr-xl rtl:rounded-tl-xl p-2 bg-gray-100 dark:bg-gray-900/60">
                        ...
                        @if (count($containers))
                            @foreach ($containers as $uuid => $row)
                                ...
                                <div
                                    ...
                                    class="flex justify-end items-center h-12 rounded-t-xl overflow-hidden border-b border-gray-950/5 dark:border-white/20"
                                >
                                    ...
                                    @if ($hasActions)
                                        <div class="p-2 w-px">
                                            <div class="flex items-center gap-x-3 lg:justify-center">
                                                @foreach ($visibleExtraItemActions as $extraItemAction)
                                                    <div>
                ...
                {{-- <div class="filament-table-repeater-component relative">
                    <div class="flex justify-end items-center h-12 overflow-hidden border-b border-gray-950/5 dark:border-white/20">
                        <div class="flex-1">第一列</div>
                        <div class="w-20 flex-1">第二列</div>
                        <div class="w-20 flex-1">第三列</div>
                    </div>
