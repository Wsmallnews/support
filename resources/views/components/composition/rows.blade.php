    ...
    @foreach ($rows as $row)
        @php
            $leftClass = match ($row['layout']) {
                CompositionRenderer::LAYOUT_LEFT_NARROW => 'lg:col-span-1',
                CompositionRenderer::LAYOUT_LEFT_WIDE => 'lg:col-span-2',
                default => 'lg:col-span-3',
            };

            $rightClass = match ($row['layout']) {
                CompositionRenderer::LAYOUT_LEFT_NARROW => 'lg:col-span-2',
                CompositionRenderer::LAYOUT_LEFT_WIDE => 'lg:col-span-1',
                default => null,
            };
        @endphp

        <div class="w-full flex flex-col lg:grid lg:grid-cols-3 items-start sn-gap">
            <div @class([
