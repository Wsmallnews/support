...
return [
    ...
    'results_tip' => 'Type a keyword to start searching',

    'exceptions' => [
        'model_required' => 'The search source [:module] is missing the required "model" option.',
        'search_not_found' => 'The search [:module] is not registered.',
